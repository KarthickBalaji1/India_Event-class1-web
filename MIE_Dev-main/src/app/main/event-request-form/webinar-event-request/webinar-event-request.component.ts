  ...
  submitForm(){
    ...
    if(this.isStep1Valid && this.isStep2Valid && this.isStep3Valid && this.isStep4Valid && this.isStep5Valid && this.isStep6Valid && this.isStep7Valid){
      let class1EventData = {
        ...
        'Sales_Head' : "joseph.s@vsaasglobal.com",
        'Marketing_Head' : "joseph.s@vsaasglobal.com",
        Finance : "joseph.s@vsaasglobal.com",
        InitiatorName : "joseph.s@vsaasglobal.com",
        'Initiator_Email' : "joseph.s@vsaasglobal.com"
      }
      const class1 = {
